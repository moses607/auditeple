...
export const REGIES_REGLEMENTATION = {
  ...
  controles_obligatoires: [
    { id: 'reg1', label: 'Existence de l\'acte constitutif de la régie (arrêté de création)', severity: 'critique' as const, ref: 'Art. 1 Décret 2019-798' },
    { id: 'reg2', label: 'Acte de nomination du régisseur', severity: 'critique' as const, ref: 'Art. 8 Décret 2019-798' },
    { id: 'reg3', label: 'Cautionnement du régisseur si montant > seuil', severity: 'majeur' as const, ref: 'Art. 9 Décret 2019-798' },
    { id: 'reg4', label: 'Plafond de l\'encaisse ou de l\'avance respecté', severity: 'critique' as const, ref: 'Art. 4 et 12 Décret 2019-798' },
    ...
    { id: 'reg7', label: 'Rapprochement solde théorique / solde réel (comptage)', severity: 'critique' as const, ref: 'M9-6 § 3.2.1' },
    { id: 'reg8', label: 'Interdiction d\'utiliser les fonds pour un usage personnel', severity: 'critique' as const, ref: 'Art. 17 Décret 2019-798' },
    { id: 'reg9', label: 'Vérification des chèques en coffre (non endossés, délai d\'encaissement)', severity: 'majeur' as const, ref: 'M9-6 § 3.2' },
    { id: 'reg10', label: 'Valeurs inactives : suivi du stock et rapprochement', severity: 'majeur' as const, ref: 'M9-6 § 3.2.3' },
    { id: 'reg11', label: 'Contrôle inopiné au moins une fois par an', severity: 'critique' as const, ref: 'Art. 18 Décret 2012-1246' },
    { id: 'reg12', label: 'Procès-verbal de contrôle établi et signé', severity: 'majeur' as const, ref: 'M9-6 § 3.2' },
  ],
};
...
export const CONTROLES_MARCHES = [
  { id: 'mp1', label: 'Respect du seuil de dispense (< 40 000 € HT)', ref: 'Art. R.2122-8 CCP', severity: 'critique' as const },
  { id: 'mp2', label: 'Publicité adaptée pour les MAPA (40 000 – 143 000 € HT)', ref: 'Art. R.2123-1 CCP', severity: 'majeur' as const },
  { id: 'mp3', label: 'Procédure formalisée pour les marchés > 143 000 € HT', ref: 'Art. R.2124-1 CCP — Seuils 2026', severity: 'critique' as const },
  { id: 'mp4', label: 'Publication au JOUE + BOAMP si seuil européen atteint', ref: 'Décrets 2025-1386/1383', severity: 'critique' as const },
  { id: 'mp5', label: 'Transmission au contrôle de légalité si montant > 90 000 € HT', ref: 'Art. L.421-14 Code Éducation', severity: 'majeur' as const },
  { id: 'mp6', label: 'Acte d\'engagement signé par l\'ordonnateur', ref: 'CCP', severity: 'critique' as const },
  { id: 'mp7', label: 'Rapport de présentation ou fiche de procédure', ref: 'CCP art. R.2184-1', severity: 'majeur' as const },
  { id: 'mp8', label: 'Mise en concurrence effective (3 devis minimum si MAPA)', ref: 'CCP — Principes fondamentaux', severity: 'majeur' as const },
  { id: 'mp9', label: 'Vérification de la non-sous-traitance non déclarée', ref: 'Art. R.2193-1 CCP', severity: 'majeur' as const },
  { id: 'mp10', label: 'Avenant éventuel voté au CA', ref: 'Art. R.421-20 Code Éducation', severity: 'majeur' as const },
];
