...
export const PARCOURS_ETAPES: EtapeParcours[] = [
  {
    ...
    moduleIds: ['parametres', 'organigramme', 'calendrier-annuel'],
  },
  {
    id: 'cadrer',
    numero: 2,
    label: 'Cadrer',
    verbe: 'Cadrage',
    description: "Délimitation du périmètre, plan de contrôle, cartographie des risques.",
    icon: Compass,
    color: 'text-section-controle-interne',
    moduleIds: ['cartographie', 'plan-controle'],
  },
  {
    id: 'controler',
    numero: 3,
  ...
  },
  {
    ...
    label: 'Restituer',
    verbe: 'Restitution',
    description: "PV d'audit, plan d'action, annexe comptable narrative.",
    icon: FileSignature,
    color: 'text-section-restitution',
    moduleIds: ['pv-audit', 'plan-action'],
  },
  {
    id: 'suivre',
    numero: 7,
