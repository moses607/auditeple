    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <Tabs defaultValue="comptage" className="w-full">
        ...
        <TabsContent value="comptage" className="space-y-4">
          ...
          {controles.length === 0 && !formCtrl && <Card><CardContent className="py-12 text-center text-muted-foreground">Aucun contrôle de caisse. Cliquez « Nouveau contrôle ».</CardContent></Card>}
        ...
        <TabsContent value="cheques" className="space-y-4">
          ...
          {cheques.length === 0 && !formCheque && <Card><CardContent className="py-12 text-center text-muted-foreground">Aucun chèque trouvé dans le coffre-fort.</CardContent></Card>}
          ...
          {cheques.length > 0 && (
            <>
              ...
              <Card><CardContent className="pt-4 text-center"><p className="text-lg font-bold">Total chèques dans le coffre : {fmt(totalCheques)}</p></CardContent></Card>
            </>
          )}
        </TabsContent>
        ...
        <TabsContent value="valeurs" className="space-y-4">
          ...
          {valeurs.length === 0 && !formValeur && <Card><CardContent className="py-12 text-center text-muted-foreground">Aucune valeur inactive enregistrée.</CardContent></Card>}
          ...
          {valeurs.length > 0 && (
            <>
              ...
              <Card><CardContent className="pt-4 text-center"><p className="text-lg font-bold">Total valeurs inactives : {fmt(totalValeurs)}</p></CardContent></Card>
            </>
          )}
        </TabsContent>
