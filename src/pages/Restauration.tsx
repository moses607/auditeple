    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <Tabs defaultValue="suivi" className="w-full">
        ...
        <TabsContent value="grammage" className="space-y-4">
          ...
          {grammages.length === 0 && !formGram && <Card><CardContent className="py-12 text-center text-muted-foreground">Aucune vérification de grammage.</CardContent></Card>}
          {grammages.length > 0 && (
            <Card><CardContent className="pt-6 overflow-x-auto">
              <table className="w-full text-sm">
        ...
        <TabsContent value="titres" className="space-y-4">
          ...
          {titresRecettes.length === 0 && !formTR && <Card><CardContent className="py-12 text-center text-muted-foreground">Aucun titre de recettes vérifié.</CardContent></Card>}
