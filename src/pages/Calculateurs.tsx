  ...
  if (id) {
    ...
    return (
      <div className="container max-w-6xl mx-auto p-4 md:p-6">
        ...
        {meta && Comp ? (
          <>
            <PageHeader title={meta.label} subtitle={meta.description} Icon={meta.icon} />
            <Comp />
          </>
        ) : (
          <PageHeader title="Calculateur introuvable" subtitle="Cet outil n'existe pas." Icon={CalcIcon} />
        )}
      </div>
    );
  }
